    ...
    <div className="relative z-10 p-8 bg-white rounded-sm shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      <div>
        ...
        <input
          type="submit"
          value="Subscribe"
          className="flex items-center justify-center w-full py-4 mb-5 text-base font-medium text-white duration-300 rounded-sm cursor-pointer bg-primary px-9 shadow-submit hover:bg-primary/90 dark:shadow-submit-dark"
        />
